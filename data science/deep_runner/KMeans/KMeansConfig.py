...
class Config:
	def __init__(
		...
		self.print_order = (
							...
							('MODEL', ('NUMBER_CLUSTERS', 'DATA_DIMENSION')),
							('TRAINING_OPTIONS', ('CUTOFF', 'NUMBER_ITER', 'EVALUATE_TEST_SET', 'EVALUATE_TRAIN_SET', 'SAVE_STATS', 'SAVE_NETWORK'))
						)
		self.configs = []
